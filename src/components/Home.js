  ...
  return (
    <div className="Home">
      ...
      <div className="Home-description">
        <p>
          Henry, un jeune homme de 29 ans, vit dans un monde où le temps à remplacer l'argent. Ce jeune homme travaille dans une usine pour survivre et gagner une certaine somme le temps de vivre une journée.
        </p>
        <p>
